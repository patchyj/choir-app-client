  ...
  return (
    <React.Fragment>
      <tr className="file-bar">
        ...
        <td className="file-bar-property">
          <form method="GET" action={'/files/download/' + encodeURIComponent(props.fileId)}>
            <button className="download-btn">{'⇩'}</button>
          </form>
        </td>
        <td className="file-bar-property">
          {/* eslint-disable-next-line jsx-a11y/accessible-emoji */}
          <div onClick={props.onDelete}>❌</div>
        </td>
        <td className="file-bar-property">
          {/* eslint-disable-next-line jsx-a11y/accessible-emoji */}
          <div onClick={props.onCopy}>📋</div>
        </td>
